                            ...
                            <aside class="dashboard-sidebar">
                                ...
                                <ul class="sidebar-menu">
                                    <li class="menu-item ${currentTab eq 'bookings' ? 'active' : ''}">
                                        <a
                                            href="${pageContext.request.contextPath}/receptionist/dashboard?tab=bookings">
                                    ...
                                    <li class="menu-item ${currentTab eq 'checkout' ? 'active' : ''}">
                                        <a
                                            href="${pageContext.request.contextPath}/receptionist/dashboard?tab=checkout">
                                    ...
                                    <li class="menu-item ${currentTab eq 'servicerequests' ? 'active' : ''}">
                                        <a
                                            ...
                                            <i class="fa-solid fa-bell-concierge"></i> <span>Quản lý yêu cầu dịch
                                                vụ</span>
                                        </a>
                                    </li>
                                </ul>
                                            ...
                                            <div class="breadcrumb">
                                                ...
                                                <span class="current">
                                                    <c:choose>
                                                        ...
                                                        <c:when test="${currentTab eq 'walkin-bookings'}">Đặt phòng tại
                                                            quầy</c:when>
                                                        <c:when test="${currentTab eq 'checkout'}">Trả phòng & Thanh
                                                            toán</c:when>
                                                        <c:when test="${currentTab eq 'servicerequests'}">Quản lý yêu
                                                            cầu dịch vụ</c:when>
                                                        ...
                                                        <%-- Toast notification --%>
                                                            <c:if test="${param.result eq 'success'}">
                                                                <div class="toast-notify toast-success">
                                                                    ...
                                                                    <c:choose>
                                                                        <c:when test="${param.action eq 'confirm'}">Đã
                                                                            xác nhận booking thành công!</c:when>
                                                                        <c:when test="${param.action eq 'reject'}">Đã từ
                                                                            chối booking.</c:when>
                                                                        <c:when test="${param.action eq 'update'}">Đã
                                                                            cập nhật thông tin booking!</c:when>
                                                                        <c:when test="${param.action eq 'cancel'}">Đã
                                                                            huỷ booking.</c:when>
                                                            ...
                                                            <c:if test="${not empty param.error}">
                                                                <div class="toast-notify toast-error">
                                                                    <i class="fa-solid fa-circle-xmark"></i>
                                                                    <c:choose>
                                                                        <c:when test="${param.error eq 'parse'}">Lỗi
                                                                            định dạng dữ liệu (ngày hoặc số không hợp
                                                                            lệ).</c:when>
                                                                        <c:when test="${param.error eq 'invalid'}">Mã
                                                                            yêu cầu hoặc trạng thái không hợp lệ.
                                                                        </c:when>
                                                                        <c:when test="${param.error eq 'validation'}">
                                                                            Thông tin không hợp lệ: vui lòng kiểm tra
                                                                            lại điều kiện nhập liệu.</c:when>
                                                                        <c:otherwise>Đã có lỗi xảy ra. Vui lòng thử lại
                                                                            sau.</c:otherwise>
                                                                    </c:choose>
                                                                </div>
                                                            </c:if>
                                                                ...
                                                                <div class="content-header-row">
                                                                    <div>
                                                                        <h2><i class="fa-solid fa-calendar-check"
                                                                            ...
                                                                            cầu đặt phòng</h2>
                                                                        <p>Xem, xác nhận, từ chối và cập nhật các yêu
                                                                            cầu đặt phòng của khách hàng.</p>
                                                                    </div>
                                                                </div>
                                                                            ...
                                                                            <%--=================HEADER=================--%>
                                                                                <div class="content-header-row">
                                                                                    <div>
                                                                                        ...
                                                                                        <p>Tạo booking trực tiếp cho
                                                                                            khách hàng tại quầy lễ tân.
                                                                                        </p>
                                                                                    </div>
                                                                                </div>
                                                                                <%--=========================================================CARD
                                                                                    ...
                                                                                    <div class="walkin-card">
                                                                                        ...
                                                                                        <div
                                                                                            class="walkin-contact-grid">
                                                                                            <div
                                                                                                class="form-group customer-name-group">
                                                                                                <label>Họ và tên
                                                                                                    *</label>
                                                                                                <input type="text"
                                                                                                    name="customerName"
                                                                            ...
                                                                            <div class="content-header-row">
                                                                                <div>
                                                                                    <h2><i class="fa-solid fa-file-invoice-dollar"
                                                                                            style="color:var(--brand-blue);margin-right:8px"></i>Trả
                                                                                        phòng & Thanh toán</h2>
                                                                                    <p>Xử lý thanh toán, phụ phí và xuất
                                                                                        hoá đơn (Iteration 3).</p>
                                                                                </div>
                                                                            </div>
                                                                            <div class="table-card"
                                                                                style="padding: 80px 20px; text-align: center; color: var(--text-muted);">
                                                                                <i class="fa-solid fa-person-digging"
                                                                                    style="font-size: 64px; margin-bottom: 20px; opacity: 0.2;"></i>
