                                            ...
                                            <%-- Hidden data container for database records --%>
                                                <div id="roomTypeDataStorage" style="display: none;">
                                                    <c:forEach var="rt" items="${roomTypesList}">
                                                        ...
                                                        data-bed-type="
                                                        <c:out value="${rt.bedType}" />"
                                                        data-area="
                                                        <c:out value="${rt.area}" />"
                                                        data-image-url="
                                                        <c:out value="${rt.imageUrl}" />"
                                                        data-description="
                                                        <c:out value="${rt.description}" />"
                                                        data-amenities="<c:forEach var="am" items="${rt.amenities}"
                                                            varStatus="st">${am}${!st.last ? ',' : ''}</c:forEach>">
                                                </div>
                                                </c:forEach>
                            </div>
                            ...
                            <%-- Alert messages --%>
                                ...
                                <c:if test="${param.error eq 'deleteError'}">
                                    <div class="alert-banner alert-danger">
                                        ...
                                        Không thể xóa loại phòng này. Loại phòng đang được sử dụng bởi phòng khác trong
                                        hệ thống.
                                    </div>
                                </c:if>
                                    ...
                                    <div class="table-card">
                                        ...
                                        <%-- Search & Dropdown Filters Bar --%>
                                            <div class="table-filter-bar"
                                                style="display: grid; grid-template-columns: 1.5fr 1fr; gap: 16px; align-items: end;">
                                                ...
                                                <div class="modal-form-group" style="margin-bottom: 0;">
                                                    ...
                                                    <select id="capacityFilter" class="status-select"
                                                        onchange="filterRoomTypes()" style="width: 100%;">
                    ...
                    <div class="modal-overlay" id="roomTypeModal">
                        <div class="modal-container" style="max-width: 600px;">
                            <div class="modal-header">
                                ...
                                <button class="btn-close-modal" onclick="closeRoomTypeModal()"><i
                                        class="fa-solid fa-xmark"></i></button>
                            </div>
                            <div class="modal-body">
                                <form id="roomTypeForm"
                                    action="${pageContext.request.contextPath}/manager/roomtypes?action=save"
                                    method="post">
                                    <input type="hidden" id="modalRtId" name="roomTypeId" value="" />

                                    <div class="modal-form-group">
                                        <label for="modalRtName">Tên loại phòng</label>
                                        <input type="text" id="modalRtName" name="name" class="modal-input"
                                            placeholder="Ví dụ: Deluxe Ocean View" required />
                                    </div>
                                    ...
                                    <div class="modal-form-group"
                                        ...
                                        <div>
                                            ...
                                            <input type="number" id="modalRtPrice" name="price" class="modal-input"
                                                placeholder="Ví dụ: 2500000" required />
                                        </div>
                                        <div>
                                            <label for="modalRtCapacity">Sức chứa (người lớn)</label>
                                            <input type="number" id="modalRtCapacity" name="capacity"
                                                class="modal-input" placeholder="Ví dụ: 2" required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal-form-group"
                                        ...
                                        <div>
                                            ...
                                            <input type="text" id="modalRtBedType" name="bedType" class="modal-input"
                                                placeholder="Ví dụ: King Bed" required />
                                        </div>
                                        <div>
                                            <label for="modalRtArea">Diện tích (m²)</label>
                                            <input type="text" id="modalRtArea" name="area" class="modal-input"
                                                placeholder="Ví dụ: 45 m²" required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal-form-group">
                                        ...
                                        <input type="text" id="modalRtImageUrl" name="imageUrl" class="modal-input"
                                            placeholder="Ví dụ: https://..." required />
                                    </div>
                                    ...
                                    <div class="modal-form-group">
                                        ...
                                        <textarea id="modalRtDescription" name="description" class="modal-textarea"
                                        ...
                                        <div
                                            ...
                                            <label
                                                ...
                                                <input type="checkbox" name="amenity" value="Wifi miễn phí"
                                                    style="width: 16px; height: 16px;" /> Wifi miễn phí
                                            </label>
                                            <label
                                                style="display: flex; align-items: center; gap: 8px; font-weight: 500; cursor: pointer;">
                                                <input type="checkbox" name="amenity" value="Điều hòa"
                                                    style="width: 16px; height: 16px;" /> Điều hòa
                                            </label>
                                            <label
                                                style="display: flex; align-items: center; gap: 8px; font-weight: 500; cursor: pointer;">
                                                <input type="checkbox" name="amenity" value="Tivi"
                                                    style="width: 16px; height: 16px;" /> Tivi
                                            </label>
                                            <label
                                                style="display: flex; align-items: center; gap: 8px; font-weight: 500; cursor: pointer;">
                                                <input type="checkbox" name="amenity" value="View thành phố"
                                                    style="width: 16px; height: 16px;" /> View thành phố
                                            </label>
                                            <label
                                                style="display: flex; align-items: center; gap: 8px; font-weight: 500; cursor: pointer;">
                                                <input type="checkbox" name="amenity" value="Mini bar"
                                                    style="width: 16px; height: 16px;" /> Mini bar
                                            </label>
                                            <label
                                                style="display: flex; align-items: center; gap: 8px; font-weight: 500; cursor: pointer;">
                                                <input type="checkbox" name="amenity" value="Bồn tắm"
                                                    style="width: 16px; height: 16px;" /> Bồn tắm
                                            </label>
                                            <label
                                                style="display: flex; align-items: center; gap: 8px; font-weight: 500; cursor: pointer;">
                                                <input type="checkbox" name="amenity" value="Ban công"
                                                    style="width: 16px; height: 16px;" /> Ban công
                                            </label>
                                            <label
                                                style="display: flex; align-items: center; gap: 8px; font-weight: 500; cursor: pointer;">
                                                <input type="checkbox" name="amenity" value="Máy pha cà phê"
                                                    style="width: 16px; height: 16px;" /> Máy pha cà phê
                                            </label>
                                        </div>
                                    </div>
