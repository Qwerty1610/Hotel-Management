    ...
    <div class="modal-container modal-lg">
        ...
        <form method="post" action="${pageContext.request.contextPath}/receptionist/booking">
            ...
            <div class="modal-body">
                ...
                <%-- Cần load roomTypeList từ manager hoặc dùng một request riêng;
                     Ở đây ta nhúng tạm danh sách cứng từ BookingDAO join RoomType --%>
                <div class="modal-grid-2">
                    <div class="modal-form-group">
                        ...
                        <select id="editRoomTypeId" name="roomTypeId" class="modal-select"
                            ...
                            <%-- Load danh sách loại phòng nếu controller đẩy roomTypesList --%>
